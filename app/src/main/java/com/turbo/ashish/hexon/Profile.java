...
public class Profile extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
                ...
                && data != null && data.getData() != null )
        {
            ...
            try {
                ...
                refProfileImage.setImageBitmap(bitmap);
                uploadImage();
            }
            catch (IOException e)
            {
    ...
    private void uploadImage() {
        if(filePath != null)
        {
            ...
            StorageReference ref = storageReference.child("Users/Profile Pictures/"+ getIntent().getExtras().get("CurrentUserUID"));
